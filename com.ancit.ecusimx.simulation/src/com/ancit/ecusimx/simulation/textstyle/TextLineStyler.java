package com.ancit.ecusimx.simulation.textstyle;
...
public class TextLineStyler implements LineStyleListener {
  ...
  void initializeColors() {
    ...
    colors = new Color[] { new Color(display, new RGB(0, 0, 0)), // black
        new Color(display, new RGB(43, 126, 227)), // lightblue
        new Color(display, new RGB(41, 138, 91)), // green
        new Color(display, new RGB(129, 51, 161)) // blue
    };
